...
import { addComment, editComment, getPost, removeComment } from '../services/PostService';
      ...
      <section className="my-20">
        ...
        }
        {
          ...
          <div className="w-full relative px-2 rounded-xl mx-auto bg-white md:drop-shadow-lg sm:px-0 sm:w-3/4 md:w-2/4">
            ...
            <img className="w-full md:drop-shadow-lg" src={post.image} alt="" />
            <div className="flex items-center justify-evenly rounded-b-xl px-6 py-2 text-xs text-white bg-neutral-900">
              <LikesButton userId={userId} postId={id as string} likes={post.likes}
              isLiked={post.likesUsers.includes(userId)} onRequestSuccess={() => {getData(false)}} />
